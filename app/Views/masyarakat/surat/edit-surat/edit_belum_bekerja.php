...
<div class="container mt-4">
    ...
    <form action="<?= site_url('masyarakat/surat/belum-bekerja/update/' . $surat['id_surat']) ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" class="form-control" id="nik" name="nik" value="<?= old('nik', $detail['nik'] ?? '') ?>" required maxlength="16" minlength="16" pattern="\d{16}" oninput="this.value = this.value.replace(/\D/g, '')" placeholder="Masukkan 16 digit NIK">
        ...
        <div class="d-flex justify-content-start align-items-center mt-3">
            <a href="/masyarakat/data-surat" class="btn btn-secondary me-2 text-white">Batal</a>
