...
<div class="surat">
    ...
    <div class="text-isi">
        ...
        <p>Adalah benar yang bersangkutan merupakan warga Desa Handil Suruk dan berdasarkan keterangan yang ada pada kami, status perkawinan yang bersangkutan adalah <strong><?= htmlspecialchars(strtoupper($status ?? '...')) ?></strong>.</p>
